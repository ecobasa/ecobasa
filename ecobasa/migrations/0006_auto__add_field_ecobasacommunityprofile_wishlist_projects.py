...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EcobasaCommunityProfile.wishlist_projects'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'wishlist_projects',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EcobasaCommunityProfile.wishlist_projects'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'wishlist_projects')
