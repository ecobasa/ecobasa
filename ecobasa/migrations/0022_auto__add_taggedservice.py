...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaggedService'
        db.create_table(u'ecobasa_taggedservice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ecobasa_taggedservice_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecobasa.EcobasaUserProfile'])),
        ))
        db.send_create_signal(u'ecobasa', ['TaggedService'])


    def backwards(self, orm):
        # Deleting model 'TaggedService'
        db.delete_table(u'ecobasa_taggedservice')
