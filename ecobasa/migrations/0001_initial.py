...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ecobasa_slideshowimage', (
            ...
            ('file', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['filer.Image'], null=True, blank=True)),
        ...
        db.create_table(u'ecobasa_ecobasauserprofile', (
            ...
            ('gender', self.gf('django.db.models.fields.CharField')(default=u'o', max_length=2, blank=True)),
            ('birth_date', self.gf('django.db.models.fields.DateField')(default=None, null=True, blank=True)),
            ('country', self.gf('django.db.models.fields.CharField')(default=u'ZZ', max_length=2, blank=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('zipcode', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('ecobasa_member', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ...
        db.create_table(u'ecobasa_ecobasacommunityprofile', (
            ...
            ('contact_country', self.gf('django.db.models.fields.CharField')(default=u'ZZ', max_length=2, blank=True)),
            ('contact_lat', self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True)),
            ('contact_lon', self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True)),
            ...
            ('basic_membership_status', self.gf('django.db.models.fields.CharField')(default=u'o', max_length=2, blank=True)),
        ))
