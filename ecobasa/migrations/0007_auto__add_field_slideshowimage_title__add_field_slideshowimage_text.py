...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SlideshowImage.title'
        db.add_column(u'ecobasa_slideshowimage', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'SlideshowImage.text'
        db.add_column(u'ecobasa_slideshowimage', 'text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SlideshowImage.title'
        db.delete_column(u'ecobasa_slideshowimage', 'title')

        # Deleting field 'SlideshowImage.text'
        db.delete_column(u'ecobasa_slideshowimage', 'text')
