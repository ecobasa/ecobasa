...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EcobasaCommunityProfile.video'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'video',
                      self.gf('django.db.models.fields.URLField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EcobasaCommunityProfile.video'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'video')
