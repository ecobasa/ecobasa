...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EcobasaCommunityProfile.network'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'network',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EcobasaCommunityProfile.network'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'network')
