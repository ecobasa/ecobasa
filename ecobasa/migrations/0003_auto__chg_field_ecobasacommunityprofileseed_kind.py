...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EcobasaCommunityProfileSeed.kind'
        db.alter_column(u'ecobasa_ecobasacommunityprofileseed', 'kind', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'EcobasaCommunityProfileSeed.kind'
        db.alter_column(u'ecobasa_ecobasacommunityprofileseed', 'kind', self.gf('django.db.models.fields.TextField')(null=True))
