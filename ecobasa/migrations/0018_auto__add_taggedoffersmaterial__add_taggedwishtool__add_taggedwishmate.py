...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaggedOffersMaterial'
        db.create_table(u'ecobasa_taggedoffersmaterial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ecobasa_taggedoffersmaterial_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecobasa.EcobasaCommunityProfile'])),
        ))
        db.send_create_signal(u'ecobasa', ['TaggedOffersMaterial'])

        # Adding model 'TaggedWishTool'
        db.create_table(u'ecobasa_taggedwishtool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ecobasa_taggedwishtool_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecobasa.EcobasaCommunityProfile'])),
        ))
        db.send_create_signal(u'ecobasa', ['TaggedWishTool'])

        # Adding model 'TaggedWishMaterial'
        db.create_table(u'ecobasa_taggedwishmaterial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ecobasa_taggedwishmaterial_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecobasa.EcobasaCommunityProfile'])),
        ))
        db.send_create_signal(u'ecobasa', ['TaggedWishMaterial'])

        # Adding model 'TaggedOffersTool'
        db.create_table(u'ecobasa_taggedofferstool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ecobasa_taggedofferstool_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecobasa.EcobasaCommunityProfile'])),
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'TaggedOffersMaterial'
        db.delete_table(u'ecobasa_taggedoffersmaterial')

        # Deleting model 'TaggedWishTool'
        db.delete_table(u'ecobasa_taggedwishtool')

        # Deleting model 'TaggedWishMaterial'
        db.delete_table(u'ecobasa_taggedwishmaterial')

        # Deleting model 'TaggedOffersTool'
        db.delete_table(u'ecobasa_taggedofferstool')

        # Adding field 'EcobasaCommunityProfile.wishlist_materials'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'wishlist_materials',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaCommunityProfile.wishlist_tools'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'wishlist_tools',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
        ...
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'basic_description')
    ...
    models = {
        ...
        u'ecobasa.ecobasacommunityprofile': {
            ...
            'contact_location_lat': ('osm_field.fields.LatitudeField', [], {}),
            'contact_location_lon': ('osm_field.fields.LongitudeField', [], {}),
