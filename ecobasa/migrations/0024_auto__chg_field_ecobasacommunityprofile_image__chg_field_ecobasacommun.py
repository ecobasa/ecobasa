...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EcobasaCommunityProfile.image'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))

        # Changing field 'EcobasaCommunityProfile.website'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'website', self.gf('django.db.models.fields.URLField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'EcobasaCommunityProfile.image'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'EcobasaCommunityProfile.website'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'website', self.gf('django.db.models.fields.URLField')(max_length=100, null=True))
