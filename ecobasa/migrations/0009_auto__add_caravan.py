...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Caravan'
        db.create_table(u'ecobasa_caravan', (
            (u'cosinnusgroup_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cosinnus.CosinnusGroup'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'ecobasa', ['Caravan'])


    def backwards(self, orm):
        # Deleting model 'Caravan'
        db.delete_table(u'ecobasa_caravan')
