...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EcobasaCommunityProfileSeed'
        db.create_table(u'ecobasa_ecobasacommunityprofileseed', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'wishlist_seeds', to=orm['ecobasa.EcobasaCommunityProfile'])),
            ('kind', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('num', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True)),
        ))
        db.send_create_signal(u'ecobasa', ['EcobasaCommunityProfileSeed'])

        # Deleting field 'EcobasaCommunityProfile.wishlist_seeds_kind'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'wishlist_seeds_kind')

        # Deleting field 'EcobasaCommunityProfile.wishlist_seeds_num'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'wishlist_seeds_num')


    def backwards(self, orm):
        # Deleting model 'EcobasaCommunityProfileSeed'
        db.delete_table(u'ecobasa_ecobasacommunityprofileseed')

        # Adding field 'EcobasaCommunityProfile.wishlist_seeds_kind'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'wishlist_seeds_kind',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaCommunityProfile.wishlist_seeds_num'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'wishlist_seeds_num',
    ...
    models = {
        ...
        u'ecobasa.ecobasacommunityprofileseed': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'kind': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
