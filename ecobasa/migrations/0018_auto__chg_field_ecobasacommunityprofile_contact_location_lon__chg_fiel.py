...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'ecobasa_ecobasacommunityprofile', u'contact_location_lon', self.gf('osm_field.fields.LongitudeField')())

        # Changing field 'EcobasaCommunityProfile.contact_location_lat'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', u'contact_location_lat', self.gf('osm_field.fields.LatitudeField')())

        # Deleting field 'EcobasaUserProfile.tour_how'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'tour_how')

        # Deleting field 'EcobasaUserProfile.ecobasa_member'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'ecobasa_member')

        # Deleting field 'EcobasaUserProfile.tour_why'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'tour_why')

        # Adding field 'EcobasaUserProfile.about'
        db.add_column(u'ecobasa_ecobasauserprofile', 'about',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaUserProfile.ecobasa_what'
        db.add_column(u'ecobasa_ecobasauserprofile', 'ecobasa_what',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaUserProfile.world'
        db.add_column(u'ecobasa_ecobasauserprofile', 'world',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EcobasaCommunityProfile.contact_location_lon'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', u'contact_location_lon', self.gf('osm_field.fields.LongitudeField')(null=True))

        # Changing field 'EcobasaCommunityProfile.contact_location_lat'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', u'contact_location_lat', self.gf('osm_field.fields.LatitudeField')(null=True))
        # Adding field 'EcobasaUserProfile.tour_how'
        db.add_column(u'ecobasa_ecobasauserprofile', 'tour_how',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaUserProfile.ecobasa_member'
        db.add_column(u'ecobasa_ecobasauserprofile', 'ecobasa_member',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EcobasaUserProfile.tour_why'
        db.add_column(u'ecobasa_ecobasauserprofile', 'tour_why',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'EcobasaUserProfile.about'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'about')

        # Deleting field 'EcobasaUserProfile.ecobasa_what'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'ecobasa_what')

        # Deleting field 'EcobasaUserProfile.world'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'world')
