...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'image',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EcobasaCommunityProfile.image'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'image')
