...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EcobasaUserProfile.address'
        db.add_column(u'ecobasa_ecobasauserprofile', 'address',
                      self.gf('osm_field.fields.OSMField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaUserProfile.address_lat'
        db.add_column(u'ecobasa_ecobasauserprofile', 'address_lat',
                      self.gf('osm_field.fields.LatitudeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaUserProfile.address_lon'
        db.add_column(u'ecobasa_ecobasauserprofile', 'address_lon',
                      self.gf('osm_field.fields.LongitudeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EcobasaUserProfile.address'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'address')

        # Deleting field 'EcobasaUserProfile.address_lat'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'address_lat')

        # Deleting field 'EcobasaUserProfile.address_lon'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'address_lon')
    ...
    models = {
        ...
        u'ecobasa.ecobasacommunityprofile': {
            ...
            'community_status': ('django.db.models.fields.CharField', [], {'default': "u'e'", 'max_length': '2', 'blank': 'True'}),
            'community_type': ('django.db.models.fields.CharField', [], {'default': "u'e'", 'max_length': '2', 'blank': 'True'}),
        ...
        u'ecobasa.ecobasauserprofile': {
            ...
            'address': ('osm_field.fields.OSMField', [], {'null': 'True', 'blank': 'True'}),
            'address_lat': ('osm_field.fields.LatitudeField', [], {'null': 'True', 'blank': 'True'}),
            'address_lon': ('osm_field.fields.LongitudeField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'ecobasa.taggedservice': {
            'Meta': {'object_name': 'TaggedService'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ecobasa.EcobasaUserProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'ecobasa_taggedservice_items'", 'to': u"orm['taggit.Tag']"})
        },
        ...
        u'ecobasa.taggedwishlist': {
            'Meta': {'object_name': 'TaggedWishlist'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ecobasa.EcobasaUserProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'ecobasa_taggedwishlist_items'", 'to': u"orm['taggit.Tag']"})
        },
