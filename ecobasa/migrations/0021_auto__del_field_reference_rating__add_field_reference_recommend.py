...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Reference.rating'
        db.delete_column(u'ecobasa_reference', 'rating')

        # Adding field 'Reference.recommend'
        db.add_column(u'ecobasa_reference', 'recommend',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Reference.rating'
        db.add_column(u'ecobasa_reference', 'rating',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Deleting field 'Reference.recommend'
        db.delete_column(u'ecobasa_reference', 'recommend')
