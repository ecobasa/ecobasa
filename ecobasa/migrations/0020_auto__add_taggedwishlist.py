...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaggedWishlist'
        db.create_table(u'ecobasa_taggedwishlist', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ecobasa_taggedwishlist_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecobasa.EcobasaUserProfile'])),
        ))
        db.send_create_signal(u'ecobasa', ['TaggedWishlist'])


    def backwards(self, orm):
        # Deleting model 'TaggedWishlist'
        db.delete_table(u'ecobasa_taggedwishlist')
