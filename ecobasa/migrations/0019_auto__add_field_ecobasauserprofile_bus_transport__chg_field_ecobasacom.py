...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EcobasaUserProfile.bus_transport'
        db.add_column(u'ecobasa_ecobasauserprofile', 'bus_transport',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'EcobasaCommunityProfile.basic_inhabitants'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'basic_inhabitants', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'EcobasaCommunityProfile.contact_location_lon'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'contact_location_lon', self.gf('osm_field.fields.LongitudeField')(null=True))

        # Changing field 'EcobasaCommunityProfile.contact_location_lat'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'contact_location_lat', self.gf('osm_field.fields.LatitudeField')(null=True))

        # Changing field 'EcobasaCommunityProfile.visitors_num'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'visitors_num', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'EcobasaUserProfile.bus_transport'
        db.delete_column(u'ecobasa_ecobasauserprofile', 'bus_transport')


        # Changing field 'EcobasaCommunityProfile.basic_inhabitants'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'basic_inhabitants', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'EcobasaCommunityProfile.contact_location_lon'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'contact_location_lon', self.gf('osm_field.fields.LongitudeField')(default=0))

        # Changing field 'EcobasaCommunityProfile.contact_location_lat'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'contact_location_lat', self.gf('osm_field.fields.LatitudeField')(default=0))

        # Changing field 'EcobasaCommunityProfile.visitors_num'
        db.alter_column(u'ecobasa_ecobasacommunityprofile', 'visitors_num', self.gf('django.db.models.fields.PositiveIntegerField')())
    ...
    models = {
        ...
        u'ecobasa.ecobasacommunityprofile': {
            ...
            'basic_description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'basic_inhabitants': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            ...
            'visitors_num': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'website': ('django.db.models.fields.URLField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'wishlist_materials_info': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'wishlist_tools_info': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        ...
        u'ecobasa.ecobasauserprofile': {
            ...
            'bus_transport': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'city': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'country': ('django.db.models.fields.CharField', [], {'default': "u'ZZ'", 'max_length': '2', 'blank': 'True'}),
            'ecobasa_what': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'world': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'ecobasa.reference': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'ecobasa.taggedoffersmaterial': {
            'Meta': {'object_name': 'TaggedOffersMaterial'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ecobasa.EcobasaCommunityProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'ecobasa_taggedoffersmaterial_items'", 'to': u"orm['taggit.Tag']"})
        },
        ...
        u'ecobasa.taggedofferstool': {
            'Meta': {'object_name': 'TaggedOffersTool'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ecobasa.EcobasaCommunityProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'ecobasa_taggedofferstool_items'", 'to': u"orm['taggit.Tag']"})
        },
        ...
        u'ecobasa.taggedwishmaterial': {
            'Meta': {'object_name': 'TaggedWishMaterial'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ecobasa.EcobasaCommunityProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'ecobasa_taggedwishmaterial_items'", 'to': u"orm['taggit.Tag']"})
        },
        ...
        u'ecobasa.taggedwishtool': {
            'Meta': {'object_name': 'TaggedWishTool'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ecobasa.EcobasaCommunityProfile']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'ecobasa_taggedwishtool_items'", 'to': u"orm['taggit.Tag']"})
        },
        'filer.file': {
