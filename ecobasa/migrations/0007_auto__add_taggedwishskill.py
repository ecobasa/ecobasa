...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaggedWishSkill'
        db.create_table(u'ecobasa_taggedwishskill', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ecobasa_taggedwishskill_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecobasa.EcobasaCommunityProfile'])),
        ))
        db.send_create_signal(u'ecobasa', ['TaggedWishSkill'])


    def backwards(self, orm):
        # Deleting model 'TaggedWishSkill'
        db.delete_table(u'ecobasa_taggedwishskill')
