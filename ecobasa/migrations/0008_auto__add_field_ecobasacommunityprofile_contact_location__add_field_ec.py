...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EcobasaCommunityProfile.contact_location'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'contact_location',
                      self.gf('osm_field.fields.OSMField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaCommunityProfile.contact_location_lat'
        db.add_column(u'ecobasa_ecobasacommunityprofile', u'contact_location_lat',
                      self.gf('osm_field.fields.LatitudeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaCommunityProfile.contact_location_lon'
        db.add_column(u'ecobasa_ecobasacommunityprofile', u'contact_location_lon',
                      self.gf('osm_field.fields.LongitudeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EcobasaCommunityProfile.contact_location'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'contact_location')

        # Deleting field 'EcobasaCommunityProfile.contact_location_lat'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', u'contact_location_lat')

        # Deleting field 'EcobasaCommunityProfile.contact_location_lon'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', u'contact_location_lon')
