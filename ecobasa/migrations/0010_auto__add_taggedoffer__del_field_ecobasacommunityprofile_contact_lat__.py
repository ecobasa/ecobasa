...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'EcobasaCommunityProfile.contact_lat'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'contact_lat')

        # Deleting field 'EcobasaCommunityProfile.contact_lon'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'contact_lon')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'EcobasaCommunityProfile.contact_lat'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'contact_lat',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaCommunityProfile.contact_lon'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'contact_lon',
                      self.gf('django.db.models.fields.FloatField')(default=0.0, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'ecobasa.taggedoffer': {
            'Meta': {'object_name': 'TaggedOffer'},
            'content_object': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ecobasa.Caravan']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'ecobasa_taggedoffer_items'", 'to': u"orm['taggit.Tag']"})
        },
