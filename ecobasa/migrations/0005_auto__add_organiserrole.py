...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OrganiserRole'
        db.create_table(u'ecobasa_organiserrole', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('cosinnus_group_membership', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cosinnus.CosinnusGroupMembership'])),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'ecobasa', ['OrganiserRole'])


    def backwards(self, orm):
        # Deleting model 'OrganiserRole'
        db.delete_table(u'ecobasa_organiserrole')
