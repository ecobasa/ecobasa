...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EcobasaCommunityProfile.community_status'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'community_status',
                      self.gf('django.db.models.fields.CharField')(default=u'e', max_length=2, blank=True),
                      keep_default=False)

        # Adding field 'EcobasaCommunityProfile.community_type'
        db.add_column(u'ecobasa_ecobasacommunityprofile', 'community_type',
                      self.gf('django.db.models.fields.CharField')(default=u'e', max_length=2, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EcobasaCommunityProfile.community_status'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'community_status')

        # Deleting field 'EcobasaCommunityProfile.community_type'
        db.delete_column(u'ecobasa_ecobasacommunityprofile', 'community_type')
