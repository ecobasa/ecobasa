...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TaggedOffers'
        db.create_table(u'ecobasa_taggedoffers', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'ecobasa_taggedoffers_items', to=orm['taggit.Tag'])),
            ('content_object', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ecobasa.Caravan'])),
        ))
        db.send_create_signal(u'ecobasa', ['TaggedOffers'])


    def backwards(self, orm):
        # Deleting model 'TaggedOffers'
        db.delete_table(u'ecobasa_taggedoffers')
