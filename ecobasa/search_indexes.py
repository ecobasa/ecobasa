...
class EcobasaCommunityProfileIndex(BasicSearchIndex, Indexable):
    ...
    basic_inhabitants = CharField(model_attr='basic_inhabitants', null=True)
    ...
    visitors_num = CharField(model_attr='visitors_num', null=True)
    community_type = CharField(model_attr='community_type', null=True)
    community_status = CharField(model_attr='community_status', null=True)
